...
&nbsp;&nbsp;&nbsp;&nbsp;  Heatmap นี้แสดงให้เห็นถึงระดับค่าฝุ่น PM 2.5 รายสัปดาห์ในแต่ละปี ซึ่งมีประโยชน์ในการวางแผนการเดินทางหรือกิจกรรมกลางแจ้ง โดยเฉพาะในจังหวัดที่มีความแตกต่างด้านคุณภาพอากาศในแต่ละช่วงเวลา
...
### Our Challenge
1.ใช้เวลาในการรวบรวมข้อมูลค่อนข้างนาน: การรวบรวมข้อมูลใช้เวลานานกว่าที่คาดไว้ เนื่องจากบางแหล่งข้อมูลมีข้อมูลที่ไม่ครบถ้วนหรือขาดหายไปมาก ทำให้เราต้องหาแหล่งข้อมูลใหม่เพื่อใช้ในการวิเคราะห์ ส่งผลให้กระบวนการทำงานล่าช้า
2.การ Clean Data: ข้อมูลที่ได้รับต้องผ่านกระบวนการเตรียมความพร้อมก่อนที่จะนำไปวิเคราะห์และทำการ Visualize ซึ่งการทำ Data Cleaning นี้ใช้เวลามาก เนื่องจากต้องจัดการกับข้อมูลที่ขาดหาย ข้อมูลที่ซ้ำซ้อน หรือข้อมูลที่มีความผิดปกติ เพื่อให้ข้อมูลมีคุณภาพและพร้อมสำหรับการนำไปวิเคราะห์อย่างถูกต้อง
3.ข้อมูลด้านอื่นที่ต้องการใช้วิเคราะห์ไม่สามารถหาได้: ข้อมูลบางส่วนที่จำเป็นสำหรับการวิเคราะห์เพิ่มเติมไม่สามารถรวบรวมได้ ทำให้ไม่สามารถดำเนินการวิเคราะห์ในบางส่วนตามที่วางแผนไว้ได้
